...
async def send_lyrics(_, message: Message):
    try:
        ...
        if len(cmd) > 1:
            ...
            await message.edit("ناوی گۆرانیەکم پێبدە")
            await asyncio.sleep(2)
            await message.delete()
            return

        await message.edit(f"ژێرنووسی `{song_name}` دەهێنرێت")
        ...
        try:
            ...
            await message.edit("ئەوە کاری نەکرد")
            await asyncio.sleep(2)
        await message.delete()
    except Exception as e:
        print(e)
        await message.edit("نەمتوانی ژێرنووسی بۆ بدۆزمەوە")
        await asyncio.sleep(2)
        await message.delete()
...
add_command_help(
    'lyrics', [
        [
            '.l یان .lyrics',
            'ژێرنووسی گۆرانیەکی دیاریکراو بدۆزەرەوە و بینێرە'
        ]
    ]
)
