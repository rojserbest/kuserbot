        ...
        if me.id in admin_ids:
            ...
            if my_permissions and my_permissions.can_change_info:
                ...
                if message.reply_to_message and message.reply_to_message.media:
                    ...
                    await UserBot.set_chat_photo(message.chat.id, file_id, file_ref=file_ref)
                    await message.edit("وێنە دانرا!")
                    return
                else:
                    # You didn't reply and it didn't have a photo either. Baka.
                    await message.edit(
                        "وەڵامی وێنەیەک بدەرەوە."
                    )
            else:
                # You literally CANNOT do this.
                await message.edit("مافی گۆڕینی وێنەت نیە.")
        else:
            # You have no business running this command.
            await message.edit("لێرە بەڕێوەبەر نیت، بەتەمای چیت؟")
    else:
        # Are you fucking dumb this is not a group ffs.
        await message.edit("ئێرە گروپ نیە دڵم.")
...
add_command_help(
    'admin', [
        ['.setpic', 'گۆرینی وێنەی گروپ بۆ ئەو وێنەیەی کە وەڵامیدەدەیتەوە']
    ]
)
